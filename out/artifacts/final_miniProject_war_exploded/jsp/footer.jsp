...
<footer>
    <div class="inner">
        ...
        <div class="info">
            <span>사업자등록번호 271-81-21345</span>
            <span>(주)탬버린즈 대표이사 땡땡떙 </span>
            <span>TEL : 02) 4895-1300 / FAX : 02) 3074-1806</span>
        </div>

        <p class="copyright">
            &copy; <span class="this-year"></span> Tamburins Korea.
        </p>
        <!--         <img src="../resources/images/tamburinsLogo.png" alt="tamburins" class="logo" />
         -->
    </div>
</footer>